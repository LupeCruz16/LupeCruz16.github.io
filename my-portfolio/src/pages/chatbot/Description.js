    ...
    return (
        <div className = "paddingGlobal">
            <div className = "largeContainer paddingSection-M">
                <div className = "chatbotProjectContainer">
